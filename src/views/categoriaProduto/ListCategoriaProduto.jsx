...
async function remover() {
    ...
    .catch((error) => {
        console.log('Erro ao remover uma Categoria do Produto.')
    })
    setOpenModal(false)
}
                              ...
                              <Table.Row key={categoriaProduto.id}>
                                  ...
                                  <Table.Cell textAlign='center'>
                                      ...
                                      <Button
                                          ...
                                          circular
                                          color='green'
                                          title='Clique aqui para editar os dados desta Categoria do Produto'
                                          icon>
                                      ...
                                      <Button
                                               ...
                                               circular
                                               color='red'
                                               title='Clique aqui para remover esta Categoria do Produto'
                                               icon 
